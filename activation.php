...
<div id="zcontentwrapper" class="zcontentwrapper">
  <div class="pageheader notab">
    <h1 class="pagetitle">Activation</h1>
  </div>
</div>
      ...
      <div style="padding: 10px 10px;">
        <span style="">
          ...
          <select name="additional_parameter" id="additional-parameter-combo" style="min-width: 200px">
            ...
            <option value="activation">Activation</option> <img id="loader_1" src="<?= base_url() ?>file/images/loaders/loader3.gif" style="display:none">
          </select>                
        </span>
        <span style="margin-left: 10px;">                 
        ...
        <span style="margin-left: 10px;">
          ...
          <input type="hidden" name="gis_category" value="activation" />
        </span>                
      </div>
      <div style="padding: 10px 10px;">
        <span style="">
...
<?php echo "showMatcodeList()"; ?>
                  ...
                  $('#expcsv').click(function(e) {
                    ...
                    window.location = "<?php echo site_url('gis/export_activation_csv'); ?>/" + $('#start_date').val() + "/" + $('#start_date').val() + "/" + $('#region-combo').val()
